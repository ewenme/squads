...
Demographic data of football (soccer) club playing squads, sourced from Transfermarkt.
...
Comes in .csv format, found in `/data` (filenames follow a `<season>_squads` naming convention). 
